...
from ..prompts import BASELINE_PROMPT_TEMPLATE


class Baseline(BaseMethod):
    """
    Baseline method that solves tasks without intermediate reasoning.
    """
    ...
    def solve(self, questions: List[str], batch_size: int = 4) -> List[str]:
        """
        Generates answers for a list of questions using a baseline prompt.
        ...
        """
        prompts = [
            BASELINE_PROMPT_TEMPLATE.format(question=question)
